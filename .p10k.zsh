# Generated by Powerlevel10k configuration wizard on 2022-11-12 at 18:02 MSK.
...
# 12h time, 2 lines, dotted, left frame, black-ornaments, sparse, many icons, fluent,
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='望'
